...
public class MainFrametest2 extends JFrame {
	...
	private void initMenu() {
		...
		JMenuItem jmi1 = new JMenuItem("匹配日志数据");
		jmi1.addActionListener(new MatchLogListener());
		JMenuItem jmi2 = new JMenuItem("匹配物流数据");
		jmi2.addActionListener(new MatchTransListener());
		menuMatch.add(jmi1); menuMatch.add(jmi2);
	...
	private void initTransGatherGUI() {
		...
		String str[] = { "发货中", "送货中", "已签收"};
		cmbTanStatus = new JComboBox<String>(str); 
	...
	private void flushMatchedTransTable() {
		//显示物流数据表格
		MatchedTableModel tranModel = new MatchedTableModel(transportService.readTransResult(), 1);
